  ...
  theme: {
  	extend: {
  		...
  		fontSize: {
  			...
  			sm:    ['0.875rem', { lineHeight: '1.55', letterSpacing: '-0.003em' }],
  			base:  ['1rem',     { lineHeight: '1.7',  letterSpacing: '-0.005em' }],
  			lg:    ['1.125rem', { lineHeight: '1.65', letterSpacing: '-0.008em' }],
  			xl:    ['1.25rem',  { lineHeight: '1.5',  letterSpacing: '-0.012em' }],
  			...
  			'8xl': ['6rem',     { lineHeight: '0.97', letterSpacing: '-0.04em'  }],
  		},
  		keyframes: {
  			'accordion-down': {
  				from: {
